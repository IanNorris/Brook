...
// Does NOT context-switch, so we only need to save/restore GPRs for the
// inner C call. Much lighter than the reschedule handler.
__attribute__((naked))
