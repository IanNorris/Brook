...
static constexpr uint64_t SYS_SCHED_SETPARAM    = 142;
static constexpr uint64_t SYS_SCHED_GETPARAM    = 143;
static constexpr uint64_t SYS_SCHED_SETSCHEDULER = 144;
static constexpr uint64_t SYS_SCHED_GETSCHEDULER = 145;
static constexpr uint64_t SYS_SCHED_GET_PRIORITY_MAX = 146;
static constexpr uint64_t SYS_SCHED_GET_PRIORITY_MIN = 147;
