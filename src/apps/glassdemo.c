...
// Letters we actually use: A B C G I L O P R S T U Y
...
static const uint8_t FONT_S[7]={0x0E,0x11,0x10,0x0E,0x01,0x11,0x0E};
...
static const uint8_t* glyph(char c) {
    ...
    switch (c) {
        ...
        case 'G': return FONT_G; case 'I': return FONT_I; case 'L': return FONT_L;
        case 'O': return FONT_O; case 'P': return FONT_P; case 'R': return FONT_R;
        case 'S': return FONT_S; case 'T': return FONT_T; case 'U': return FONT_U;
        case 'Y': return FONT_Y; case '%': return FONT_PCT;
